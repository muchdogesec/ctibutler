...
* `F3_BUCKET_ROOT_PATH`: `https://downloads.ctibutler.com/mitre-f3-repo-data/`
...
* `CLOAK_BUCKET_ROOT_PATH`: `https://downloads.ctibutler.com/cloak2stix-manual-output/`
