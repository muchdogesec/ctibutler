...
ALL_SEARCH_TYPES = CAPEC_TYPES.union(LOCATION_TYPES, SOFTWARE_TYPES, ATTACK_TYPES, DISARM_TYPES, F3_TYPES, CLOAK_TYPES, CWE_TYPES, TLP_TYPES, ATLAS_TYPES)
