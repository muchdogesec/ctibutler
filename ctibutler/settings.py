...
SPECTACULAR_SETTINGS: dict[str, Any] = {
    ...
    "TAGS": [
        ...
        {"name": "CLOAK", "description": "Manage and search Concealment Layers for Online Anonymity and Knowledge objects."},
...
CLOAK_BUCKET_ROOT_PATH = os.environ["CLOAK_BUCKET_ROOT_PATH"]
