...
CORS_ALLOWED_ORIGINS = os.environ.get(
    "DJANGO_CORS_ALLOWED_ORIGINS", "http://127.0.0.1:8006"
).split()
...
SPECTACULAR_SETTINGS: dict[str, Any] = {
    ...
    "TAGS": [
        {"name": "Search", "description": "Search for data across all knowledgebases."},
        {
            ...
            "description": "Manage and search MITRE ATT&CK Enterprise objects.",
        },
        {
            "name": "ATT&CK ICS",
            "description": "Manage and search MITRE ATT&CK ICS objects.",
        },
        {
            "name": "ATT&CK Mobile",
            "description": "Manage and search MITRE ATT&CK Mobile objects.",
        },
        ...
        {
            "name": "Arango CTI Processor",
            "description": "Trigger the generation of relationships between objects.",
        },
        {
            "name": "Jobs",
            "description": "Search through Jobs triggered when downloading data and creating relationships.",
        },
